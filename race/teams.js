...
loadDatabase = () => {
    ...
    d3.json(`./team_scores_from_users.json?t=${Date.now()}`, d3.autoType,).then(async function (data) {
        ...
        for (const row of data) {
            ...
            partial.set(row.teamname, (partial.get(row.teamname) || 0) + 1);
